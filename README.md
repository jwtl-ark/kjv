...
* Misc: also includes an index.md and a nested dict format json file for the whole King James Bible

You can simply download the whole zip file and extra it into your Bible Study Obsidian vault.

Quote Method in Obsidian:
```
